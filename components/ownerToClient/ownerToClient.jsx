            ...
            <div className="bg-blue-600/60 p-5 rounded-md">
                ...
                <div className="flex items-center justify-between mx-auto w-[40%] h-[100px]">
                    <div className="flex items-start justify-center w-[0.2px] bg-gray-900/20">
                        <div className="flex items-start justify-start h-[100px] bg-transparent animate-topToBottom">  <MdOutlineMarkEmailRead className="text-3xl text-slate-200" /></div>
                    </div>
                    <div className="flex items-start justify-center w-[0.2px] bg-gray-900/20">
                        <div className="flex items-end justify-end h-[100px] delay-300 animate-bottomToTop">  <FaRegFileAlt className="text-3xl text-slate-200" /></div>
                    </div>
                </div>
