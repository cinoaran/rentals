                ...
                <div className="flex items-center justify-center p-6 rounded-md w-full">
                    <form action="" className="mx-auto max-w-2xl w-full flex flex-col md:flex-row items-center gap-5 text-gray-700">
                        <div className="w-full md:w-7/8 mb-2 md:mb-0">
                            ...
                            <input type="text" placeholder="Enter your location" name="location" className="p-3 w-full rounded-md" id="location" />
                        </div>
                        ...
                        <button type="submit" className="display-block w-full px-6 py-3 mb-10 md:mb-0 rounded-lg bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-500">
                            Search
                        </button>
                    </form>
                </div>
